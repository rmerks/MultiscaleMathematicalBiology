...
def _make_solver():
    ...
    # This is the interaction matrix, Tab in the paper.
    ...
    # The effect of bicoid
    m[:] = [1.8, 7.6, 1.1, -1.8, 14]

    # The `base' activation level of each gene
    h[:] = [-1.5, -18, 0.59, -4.5, 4.4]

    # The effect of the activation.
    ...
    return Solver(N, M, R, T,m,h,D,lamb, names=names, noflux=True)
